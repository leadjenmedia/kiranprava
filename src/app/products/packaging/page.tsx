...
import { ArrowRight, CheckCircle2, Package, Cpu } from "lucide-react";
...
const packagingProducts = [
    ...
    {
        title: "Case Erectors & Sealers",
        description: "Automated case forming, product loading, and sealing for end-of-line efficiency. Configurable for various carton sizes and speeds.",
        image: "/assets/packaging_machine_industrial.png",
        specs: ["Multiple Formats", "Quick Changeover", "Low Maintenance"],
    },
];
    ...
    return (
        <main className="min-h-screen">
            ...
            <PageHero
                ...
                subtitle="Intelligent automated packaging systems designed to reduce labor costs and increase throughput with absolute reliability."
                image="/assets/packaging_machine_industrial.png"
                    ...
                    <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
                        ...
                        >
                            <div className="relative overflow-hidden border border-gray-200">
                                <Image
                                    src="/assets/packaging_machine_industrial.png"
                        ...
                        <div className="order-1 lg:order-2">
                            ...
                            <h2 className="text-2xl sm:text-3xl md:text-4xl font-heading font-bold text-industrial-charcoal mb-4 sm:mb-6">
                                End-of-Line Intelligence. <span className="text-primary">Maximum Throughput.</span>
                            </h2>
                            <p className="text-gray-500 font-body mb-6 sm:mb-8 leading-relaxed text-sm sm:text-base">
                                Our packaging systems integrate case erecting, product loading, sealing, and palletizing into seamless end-of-line workflows. Modular, PLC-controlled, and built for 24/7 operations across FMCG, pharma, and industrial sectors.
                            </p>
                            <div className="space-y-3 sm:space-y-4">
                                {[
                                    { icon: <Package size={20} className="text-blue-500 flex-shrink-0" />, text: "Case erectors, sealers, and wrappers for varied carton formats" },
                                    { icon: <Cpu size={20} className="text-blue-500 flex-shrink-0" />, text: "Smart PLC control with HMI, remote monitoring, and diagnostics" },
                                    { icon: <CheckCircle2 size={20} className="text-blue-500 flex-shrink-0" />, text: "Modular design for quick changeover and future expansion" },
                                ].map((item, i) => (
            ...
            <section className="py-16 sm:py-24 bg-[#fafafa] relative overflow-hidden">
                <div className="section-container relative z-10">
                    ...
                    <h3 className="text-2xl sm:text-3xl md:text-5xl font-heading font-bold text-industrial-charcoal mb-10 sm:mb-16">
                        Explore Our <span className="text-primary">Packaging Systems</span>
                    </h3>
